...
<head>
  ...
  <title>Trivy Container Image Security Report</title>
  <style>
    :root {
      --bg-color: #f0f2f5;
      --card-bg: #ffffff;
...
<body>
  ...
  <div class="header">
    <h1>🛡️ Container Image Security Report</h1>
    <p class="subtitle">Generated by Trivy (image scanner) via GitHub Actions</p>
  </div>
